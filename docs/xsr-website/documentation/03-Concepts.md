...
## Encapsulation of services {#EncapsulationOfServices}
...
## Perspectives in a SOA model {#ModelPerspectives}
...
### Service model {#ServiceModelPerspective}
...
#### Versions and lifecycle states {#VersionAndLifecycles}
...
### Runtime environment {#EnvironmentPerspective}
...
### Module and service bindings to the runtime {#BindingPerspective}
...
#### Effective binding for modules consuming other modules {#UsedModuleBinding}
...
### Service level agreements {#SLAPerspective}
...
### Describing semantics {#Semantics}
...
### Business view {#BusinessModelPerspective}
...
### The base DSL for most models {#BaseDSL}
...
## Modeling with Domain Specific Languages {#ModelingWithDSLs}
