...
public class NewSolDslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.xkonnex.repo.dsl.semanticsdsl.ui.wizard.NewSLADslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewSolDslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewSolDslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewSolDslFileWizard_title);
		mainPage.setDescription(Messages.NewSolDslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewSolDslFileWizard_title);
