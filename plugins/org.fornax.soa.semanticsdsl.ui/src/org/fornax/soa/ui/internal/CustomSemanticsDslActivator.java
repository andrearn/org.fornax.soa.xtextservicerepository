...
public class CustomSemanticsDslActivator extends SemanticsDslActivator {
	...
	public void start(BundleContext context) throws Exception {
		super.start (context);
		Injector injector = getInjector ("org.fornax.soa.SemanticsDsl");
		IPluggableValidatorProvider validatorProvider = injector.getInstance (IPluggableValidatorProvider.class);
	
        try {
            final IConfigurationElement[] confEl = RegistryFactory.getRegistry().getConfigurationElementsFor ("org.fornax.soa.semanticsdsl.ui.SemanticsDSLValidator");
