package org.fornax.soa.semanticsdsl.ui.wizard;
...
public class NewSemanticsDslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.fornax.soa.semanticsdsl.ui.wizard.NewSemanticsDslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewSemanticsDslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewSemanticsDslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewSemanticsDslFileWizard_title);
		mainPage.setDescription(Messages.NewSemanticsDslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewSemanticsDslFileWizard_title);
