...
import org.xkonnex.repo.dsl.servicedsl.validation.AbstractServiceDslJavaValidator;
...
public class ServiceDslJavaValidator extends AbstractServiceDslJavaValidator {
	...
	public void checkUniqueSimpleAttributeNames(SimpleAttribute prop) {
		if (prop.eContainer() instanceof org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception) {
			org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception exc = (org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception) prop
					.eContainer();
			final String propName = prop.getName();
...
//	}
	...
	public void checkProvidedDefOnInternalEnumOnly(
			org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception o) {
		if (o.getProvidedContractUrl() != null
				&& o.eContainer() instanceof DomainNamespace)
