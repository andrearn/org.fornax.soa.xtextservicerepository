package org.fornax.soa.sladsl.ui.wizard;
...
public class NewSLADslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.fornax.soa.ui.wizard.NewSLADslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewSLADslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewSLADslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewSLADslFileWizard_title);
		mainPage.setDescription(Messages.NewSLADslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewSLADslFileWizard_title);
