/*
 * derived from XtextPluginImages
 */
...
public class ServiceRepositoryPluginImages {

	private static final String NAME_PREFIX = ServiceRepositoryActivator.PLUGIN_ID + "."; //$NON-NLS-1$
	...
	private static URL makeImageURL(String prefix, String name) {
		...
		return FileLocator.find(ServiceRepositoryActivator.getInstance().getBundle(), new Path(path), null);
	}
