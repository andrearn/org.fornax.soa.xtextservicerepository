...
public class SOAProfileDslLabelProvider extends DefaultEObjectLabelProvider {
	...
	Object text (org.xkonnex.repo.dsl.profiledsl.sOAProfileDsl.Class ele) {
	...
	String image (org.xkonnex.repo.dsl.profiledsl.sOAProfileDsl.Class ele) {
		return "full/obj16/bo_obj.gif";
	}
	
	Object text (org.xkonnex.repo.dsl.profiledsl.sOAProfileDsl.Enumeration ele) {
		StyledString name = new StyledString(ele.getName());
		StyledString versionAndState  = new StyledString(" " + ele.getVersion().getVersion() + " " + ele.getState().getName (), StyledString.DECORATIONS_STYLER);
		name.append(versionAndState);
		return name;
	}
	String image (org.xkonnex.repo.dsl.profiledsl.sOAProfileDsl.Enumeration ele) {
