...
public class RelaxedLatestMinVersionForOwnerStateFilter<T> extends LatestMinInclVersionFilter<T> {
	...
	public RelaxedLatestMinVersionForOwnerStateFilter (IScopeVersionResolver resolver, String minVersion, ILifecycleStateResolver stateResolver, LifecycleState ownerLifecycleState, ResourceSet resourceSet) {
