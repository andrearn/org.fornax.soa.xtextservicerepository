...
public class RelaxedEarliestMinMaxVersionForOwnerStateFilter<T> extends LatestMinInclMaxExclRangeVersionFilter<T> {
	...
	public RelaxedEarliestMinMaxVersionForOwnerStateFilter (IScopeVersionResolver resolver, String minVersion, String maxVersion, ILifecycleStateResolver stateResolver, LifecycleState ownerLifecycleState, ResourceSet resourceSet) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof RelaxedEarliestMinMaxVersionForOwnerStateFilter))
			return false;
		RelaxedEarliestMinMaxVersionForOwnerStateFilter<T> other = (RelaxedEarliestMinMaxVersionForOwnerStateFilter<T>) obj;
		if (maxVersion == null) {
