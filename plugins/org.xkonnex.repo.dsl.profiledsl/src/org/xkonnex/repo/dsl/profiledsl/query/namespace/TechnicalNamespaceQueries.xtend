...
class TechnicalNamespaceQueries {
	...
	def TechnicalNamespace findOwnerSubdomain (org.xkonnex.repo.dsl.profiledsl.profileDsl.VersionedTypeRef c) {
		val TechnicalNamespace ns = c.getOwnerByType(typeof (TechnicalNamespace))
		return ns
	}
	
		
	def TechnicalNamespace findTechnicalNamespace (org.xkonnex.repo.dsl.profiledsl.profileDsl.VersionedType c) {
