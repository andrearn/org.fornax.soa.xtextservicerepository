package org.xkonnex.repo.dsl.sladsl.validation;
...
public class SLADslValidator extends AbstractPluggableDeclarativeValidator {
	...
	protected List<EPackage> getEPackages() {
	    ...
	    result.add(org.xkonnex.repo.dsl.sladsl.sLADsl.SLADslPackage.eINSTANCE);
		return result;
	}
