package org.xkonnex.repo.dsl.environmentdsl.validation;
...
public class EnvironmentDslValidator extends AbstractPluggableDeclarativeValidator {
	...
	protected List<EPackage> getEPackages() {
	    ...
	    result.add(org.xkonnex.repo.dsl.environmentdsl.environmentDsl.EnvironmentDslPackage.eINSTANCE);
		return result;
	}
