...
public class ReferencedTypesFinder {
  ...
  private List<TypeRef> _allReferencedTypeRefs(final Type t) {
    ArrayList<TypeRef> _newArrayList = CollectionLiterals.<TypeRef>newArrayList();
    return _newArrayList;
  }
  
  private List<TypeRef> _allReferencedTypeRefs(final BusinessObject t) {
  ...
  private List<TypeRef> _allReferencedTypeRefs(final QueryObject t) {
    ArrayList<TypeRef> _arrayList = new ArrayList<TypeRef>();
    ArrayList<TypeRef> refs = _arrayList;
  ...
  private List<TypeRef> _allReferencedTypeRefs(final org.fornax.soa.serviceDsl.Exception t) {
  ...
  private List<TypeRef> _allReferencedTypeRefs(final Parameter p) {
    TypeRef _type = p.getType();
    ArrayList<TypeRef> _newArrayList = CollectionLiterals.<TypeRef>newArrayList(_type);
    return _newArrayList;
  }
  
  private List<TypeRef> _allReferencedTypeRefs(final Operation o) {
  ...
  private List<TypeRef> _allReferencedTypeRefs(final Service s) {
  ...
  private List<TypeRef> allReferencedTypeRefs(final EObject t) {
    if (t instanceof BusinessObject) {
