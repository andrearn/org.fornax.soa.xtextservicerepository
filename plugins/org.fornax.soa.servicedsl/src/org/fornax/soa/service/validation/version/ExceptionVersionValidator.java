...
public class ExceptionVersionValidator extends AbstractServiceDslVersionValidator {
	...
	public void checkExceptionBackwardCompatibility (final org.fornax.soa.serviceDsl.Exception ex) {
		...
		if (nextLesserVersion != null) {
			...
			if (eObject instanceof org.fornax.soa.serviceDsl.Exception) {
				org.fornax.soa.serviceDsl.Exception otherEx  = (org.fornax.soa.serviceDsl.Exception)eObject;
	...
	public void checkExceptionPropertyBackwardCompatibility (final SimpleAttribute prop) {
		...
		if (nextLesserVersion != null) {
			...
			if (eObject instanceof org.fornax.soa.serviceDsl.Exception) {
				org.fornax.soa.serviceDsl.Exception otherBo  = (org.fornax.soa.serviceDsl.Exception)eObject;
