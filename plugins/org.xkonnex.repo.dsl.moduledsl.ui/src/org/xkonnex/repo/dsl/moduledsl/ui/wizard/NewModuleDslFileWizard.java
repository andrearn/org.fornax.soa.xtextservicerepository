package org.xkonnex.repo.dsl.moduledsl.ui.wizard;
...
public class NewModuleDslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.xkonnex.repo.dsl.semanticsdsl.moduledsl.ui.wizard.NewModuleDslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewModuleDslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewModuleDslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewModuleDslFileWizard_title);
		mainPage.setDescription(Messages.NewModuleDslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewModuleDslFileWizard_title);
