package org.xkonnex.repo.dsl.moduledsl.ui.internal;
...
import org.xkonnex.repo.dsl.moduledsl.ui.internal.ModuleDslActivator;
...
public class CustomModuleDslActivator extends ModuleDslActivator {
	...
	public void start(BundleContext context) throws Exception {
		super.start (context);
		Injector injector = getInjector ("org.xkonnex.repo.dsl.semanticsdsl.moduledsl.ModuleDsl");
		IPluggableValidatorProvider validatorProvider = injector.getInstance (IPluggableValidatorProvider.class);
	
        try {
            final IConfigurationElement[] confEl = RegistryFactory.getRegistry().getConfigurationElementsFor ("org.xkonnex.repo.dsl.semanticsdsl.moduledsl.ui.ModuleDSLValidator");
