...
public interface IModuleEndpointProtocolLookup {
	...
	public List<IModuleEndpointProtocol> collectEndpointProtocolHierarchyByType (Resource resource, Module module, IModuleEndpointProtocol protocol);
	
	public List<IModuleEndpointProtocol> collectEndpointProtocolHierarchyByType (AbstractOperation operation, Module module, IModuleEndpointProtocol protocol);
