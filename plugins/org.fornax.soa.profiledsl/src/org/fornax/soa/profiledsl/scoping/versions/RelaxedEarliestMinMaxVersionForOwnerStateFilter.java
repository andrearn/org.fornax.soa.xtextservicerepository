...
public class RelaxedEarliestMinMaxVersionForOwnerStateFilter<T> extends LatestMinInclMaxExclRangeVersionFilter<T> {
	...
	public RelaxedEarliestMinMaxVersionForOwnerStateFilter (VersionResolver resolver, String minVersion, String maxVersion, LifecycleStateResolver stateResolver, LifecycleState ownerLifecycleState) {
