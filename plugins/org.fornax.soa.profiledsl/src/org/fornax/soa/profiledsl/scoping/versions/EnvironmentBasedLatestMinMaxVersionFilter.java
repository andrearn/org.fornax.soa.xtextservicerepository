...
public class EnvironmentBasedLatestMinMaxVersionFilter<T> extends
		LatestMinInclMaxExclRangeVersionFilter<T> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof EnvironmentBasedLatestMinMaxVersionFilter))
			return false;
		EnvironmentBasedLatestMinMaxVersionFilter<T> other = (EnvironmentBasedLatestMinMaxVersionFilter<T>) obj;
		if (minVersion == null) {
