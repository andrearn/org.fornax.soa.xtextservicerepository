...
public class RelaxedMaxVersionForOwnerStateFilter<T> extends
	...
	public RelaxedMaxVersionForOwnerStateFilter (IScopeVersionResolver resolver, String maxVersion, ILifecycleStateResolver stateResolver, LifecycleState ownerLifecycleState, ResourceSet resourceSet) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof RelaxedMaxVersionForOwnerStateFilter))
			return false;
		RelaxedMaxVersionForOwnerStateFilter<T> other = (RelaxedMaxVersionForOwnerStateFilter<T>) obj;
		if (maxVersion == null) {
