...
public class RelaxedEarliestMaxVersionForOwnerStateFilter<T> extends
	...
	public RelaxedEarliestMaxVersionForOwnerStateFilter (VersionResolver resolver, String maxVersion, LifecycleStateResolver stateResolver, LifecycleState ownerLifecycleState) {
