...
public class NewEnvDslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.xkonnex.repo.dsl.semanticsdsl.ui.wizard.NewEnvDslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewEnvDslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewEnvDslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewEnvDslFileWizard_title);
		mainPage.setDescription(Messages.NewEnvDslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewEnvDslFileWizard_title);
