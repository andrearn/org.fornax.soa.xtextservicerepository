...
//import org.fornax.soa.service.ui.hierarchy.IEObjDescrHierarchyLifeCycleListener;
//import org.fornax.soa.service.ui.hierarchy.ITypeHierarchyViewPart;
...
import org.fornax.soa.basedsl.ui.hierarchy.IEObjectDescriptionHierarchyViewPart;
import org.fornax.soa.service.ui.hierarchy.TraditionalHierarchyViewer;
	...
	private void initializeTypesViewer(final TypeHierarchyViewer typesViewer, KeyListener keyListener, String cotextHelpId) {
		...
		typesViewer.initContextMenu(new IMenuListener() {
			...
			private void fillTypesViewerContextMenu(
					TypeHierarchyViewer typesViewer, IMenuManager menu) {
				// TODO Auto-generated method stub
