...
import org.fornax.soa.service.ui.hierarchy.SuperTypeHierarchyViewer.SuperTypeHierarchyContentProvider;
import org.fornax.soa.service.ui.hierarchy.TraditionalHierarchyViewer.TraditionalHierarchyContentProvider;
import org.fornax.soa.serviceDsl.Property;
import org.fornax.soa.ui.internal.Messages;
import org.fornax.soa.ui.internal.ServiceDslActivator;
import org.fornax.soa.ui.internal.ServiceDslCustomActivator;
 ...
 * @since 1.6
 */
public class HierarchyInformationControl extends org.fornax.soa.service.ui.hierarchy.AbstractInformationControl {
	...
	public HierarchyInformationControl(Shell parent, int shellStyle, int treeStyle, Injector injector) {
		super(parent, shellStyle, treeStyle, "org.fornax.soa.ServiceDsl.ui.hierarchy.QuickTypeHierarchy"/*IJavaEditorActionDefinitionIds.OPEN_HIERARCHY*/, true);
	...
	protected TreeViewer createTreeViewer(Composite parent, int style) {
		...
		injector = ServiceDslCustomActivator.getInstance().getInjector(ServiceDslActivator.ORG_FORNAX_SOA_SERVICEDSL);
	...
	protected String getId() {
		return "org.fornax.soa.service.ui.hierarchy.QuickTypeHierarchy"; //$NON-NLS-1$
	}
