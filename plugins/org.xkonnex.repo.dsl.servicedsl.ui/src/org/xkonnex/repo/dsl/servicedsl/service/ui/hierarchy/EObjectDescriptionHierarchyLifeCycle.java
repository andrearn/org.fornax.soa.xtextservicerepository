...
public class EObjectDescriptionHierarchyLifeCycle implements IEObjectDescrHierarchyChangedListener, IEObjectDescriptionHierarchyLifeCycle {
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#getHierarchy()
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#getInputElements()
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#freeHierarchy()
	 */
...
//		}
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#removeChangedListener(org.xkonnex.repo.dsl.basedsl.ui.hierarchy.IEObjDescrHierarchyLifeCycleListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#addChangedListener(org.xkonnex.repo.dsl.basedsl.ui.hierarchy.IEObjDescrHierarchyLifeCycleListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#ensureRefreshedTypeHierarchy(org.eclipse.xtext.resource.IEObjectDescription, org.eclipse.jface.operation.IRunnableContext)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#ensureRefreshedTypeHierarchy(java.util.List, org.eclipse.jface.operation.IRunnableContext)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#isRefreshJobRunning()
	 */
	...
	private EObjectDescriptionHierarchy createHierarchy(List<IEObjectDescription> elements, IProgressMonitor pm) {
		...
		if (elements.size() == 1 && ServiceDslPackage.Literals.BUSINESS_OBJECT.equals(elements.get(0).getEClass())) {
			...
			if (fIsSuperTypesOnly) {
				...
				DataObjectQueries boQuery = injector.getInstance(DataObjectQueries.class);
				DataObject rootBO = boQuery.getRootDataObject(queryBO);
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#doHierarchyRefresh(java.util.List, org.eclipse.core.runtime.IProgressMonitor)
	 */
...
//		JavaCore.addElementChangedListener(this);
	 ...
	 */
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#hierarchyChanged(org.xkonnex.repo.dsl.basedsl.ui.hierarchy.EObjectDescriptionHierarchy)
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#getInjector()
	 */
	...
	/* (non-Javadoc)
	 * @see org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.IEObjectDescriptionHierarchyLifeCycle#setInjector(com.google.inject.Injector)
	 */
