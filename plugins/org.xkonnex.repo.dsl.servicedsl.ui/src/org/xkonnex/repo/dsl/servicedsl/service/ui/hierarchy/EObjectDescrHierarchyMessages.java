...
public final class EObjectDescrHierarchyMessages extends NLS {

	private static final String BUNDLE_NAME= "org.xkonnex.repo.dsl.semanticsdsl.service.ui.hierarchy.messages";//$NON-NLS-1$

	private EObjectDescrHierarchyMessages() {
		// Do not instantiate
	}

	public static String OpenTypeHierarchyCommand_description;
	public static String QuickTypeHierarchyCommand_description;
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, EObjectDescrHierarchyMessages.class);
	}
}
