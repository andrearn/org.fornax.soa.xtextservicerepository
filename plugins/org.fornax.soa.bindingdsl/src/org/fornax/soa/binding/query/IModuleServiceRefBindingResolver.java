...
/**
 * Resolve bindings for modules to {@link ModuleServiceRefBindingDescription}s describing with which binding
 * providing module provide which set of services.
 * 
 * @author aarnold
 */
@ImplementedBy (DefaultModuleServiceRefBindingResolver.class)
public interface IModuleServiceRefBindingResolver {
	 ...
	 */
	public abstract Set<ModuleServiceRefBindingDescription> resolveCompatibleUsedServiceBindings(final Module module,
	 ...
	 * 								have any or no potentially effective endpoint qualifier
	 */
	public abstract Set<ModuleServiceRefBindingDescription> resolveCompatibleProvidedServiceBindings(
