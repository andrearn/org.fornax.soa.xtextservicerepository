define([], function() {
	var keywords = "DELETE|GET|HEAD|PATCH|POST|PUT|URI|abstract|accepted|aggregate|as|async|budgeting|businessObject|calling|channel|command|considers|default|deferred|denied|domain|entity|enum|event|exception|extends|false|fixedVersion|frozen|historized|idempotent|import|license|links|location|majorVersion|mandatory|maxVersion|metadata|minVersion|no|none|oneway|optional|owner|page|parameter|pattern|pending|persistence|private|public|publishers|queryObject|read|replaces|requires|resource|responsible|returns|section|service|set|shortname|specific|stateful|statefulness|stateless|subject|subscribers|subscriptions|sync|tags|throws|tolerated|topic|transactional|true|type|updating|valueObject|version|weak|write|yes";
	return {
		id: "xtext.svcdsl",
