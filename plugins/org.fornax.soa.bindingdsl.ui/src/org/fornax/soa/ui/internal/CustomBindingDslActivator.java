...
public class CustomBindingDslActivator extends BindingDslActivator {
	...
	public void start(BundleContext context) throws Exception {
		super.start (context);
		Injector injector = getInjector ("org.fornax.soa.BindingDsl");
		IPluggableValidatorProvider validatorProvider = injector.getInstance (IPluggableValidatorProvider.class);
	
        try {
            final IConfigurationElement[] confEl = RegistryFactory.getRegistry().getConfigurationElementsFor ("org.fornax.soa.bindingdsl.ui.BindingDSLValidator");
