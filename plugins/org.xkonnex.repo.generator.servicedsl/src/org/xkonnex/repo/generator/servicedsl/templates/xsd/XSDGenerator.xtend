...
class XSDGenerator {
	...
	*/
	def dispatch toXSD (SubNamespace ns, String minState, org.xkonnex.repo.dsl.profiledsl.sOAProfileDsl.SOAProfile profile, String registryBaseUrl) {
	...
	*/
	...
	def dispatch toPropertySequenceWithAny (org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception ex, VersionedDomainNamespace currNs, SOAProfile profile, LifecycleState minState) '''
		<xsd:sequence>
	...
	def dispatch toPropertySequence(org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception ex, VersionedDomainNamespace currNs, SOAProfile profile, LifecycleState minState) '''
		<xsd:sequence>
			«ex.properties.map (e|e.toProperty (currNs, profile, minState)).join»
		</xsd:sequence>
	'''
	...
	/*
		...
		@param		profile	The SOAProfile defining the governing architecture rules.
	*/
	def toFaultType (org.xkonnex.repo.dsl.servicedsl.serviceDsl.Exception ex, VersionedDomainNamespace currNs, SOAProfile profile, LifecycleState minState) '''
