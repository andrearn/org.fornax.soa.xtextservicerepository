...
public class VersionRefMatcher {
	...
	/**
	 * tests, whether the version constraint ref1 matches, i.e. ref1 is fully covered by the version constraint ref2
	 */
	public boolean matches (VersionRef ref1, VersionRef ref2) {
		if (ref1 instanceof MajorVersionRef) {
			...
			if (ref2 instanceof MajorVersionRef) {
				...
				return VersionComparator.compare(verRef1.getMajorVersion(), verRef2.getMinVersion()) >= 0 &&
						VersionComparator.compare(verRef1.getMajorVersion(), verRef2.getMaxVersion()) < 0;
			...
			if (ref2 instanceof MajorVersionRef) {
				MajorVersionRef verRef2 = (MajorVersionRef) ref2;
				return VersionComparator.compare (LatestMajorVersionFilter.toMajorVersion(verRef1.getMinVersion()), verRef2.getMajorVersion()) >= 0 &&
						VersionComparator.compare (LatestMajorVersionFilter.toMajorVersion(verRef1.getMaxVersion()), verRef2.getMajorVersion()) <= 0;
