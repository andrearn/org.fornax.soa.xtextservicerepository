define([], function() {
	var keywords = "DLL|EAR|JAR|OSGi|OTHER|WAR|WebMethods|ZIP|accepted|artifactId|budgeting|channel|client|default|denied|excluding|external|false|fixedVersion|frozen|groupId|import|including|license|location|majorVersion|maxVersion|minVersion|module|namespace|operations|optional|owner|parameters|pending|provides|public|qualifier|reference|resource|responsible|service|specific|subject|subscriptions|tags|true|type|uses|version";
	return {
		id: "xtext.moddsl",
