...
public class IIOP implements IProtocol {
	...
	public boolean supportsModuleEndpointProtocol(
		...
		if (endpointProtocol instanceof org.xkonnex.repo.dsl.moduledsl.ext.protocol.IIOP)
			return true;
		else
			return false;
	}
	...
	public boolean supportsModuleEndpointProtocol(
		...
		return org.xkonnex.repo.dsl.moduledsl.ext.protocol.IIOP.class.isAssignableFrom(endpointProtocol);
	}
