...
public class NewBindDslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.xkonnex.repo.dsl.bindingdsl.ui.wizard.NewBindDslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewBindDslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewBindDslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewBindDslFileWizard_title);
		mainPage.setDescription(Messages.NewBindDslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewBindDslFileWizard_title);
