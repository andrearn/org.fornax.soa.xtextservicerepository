 ...
 */
package org.xkonnex.repo.dsl.profiledsl.tests
...
@RunWith(XtextRunner)
@InjectWith(ProfileDslInjectorProvider)
class ProfileDslParsingTest{

	@Inject
	ParseHelper<ProfileModel> parseHelper;
