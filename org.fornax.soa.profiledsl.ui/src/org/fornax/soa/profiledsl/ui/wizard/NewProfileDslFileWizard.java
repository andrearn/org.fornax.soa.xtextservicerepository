package org.fornax.soa.profiledsl.ui.wizard;
...
public class NewProfileDslFileWizard extends BasicNewResourceWizard {
	public static final String WIZARD_ID = "org.fornax.soa.profiledsl.ui.wizard.NewProfileDslFileWizard"; //$NON-NLS-1$

	private WizardNewFileCreationPage mainPage;

	private static final Logger logger = Logger.getLogger(NewProfileDslFileWizard.class);
	...
	public void addPages() {
		...
		mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) { //$NON-NLS-1$
			...
			protected InputStream getInitialContents() {
				...
				if (module != null) {
					String content = String.format(Messages.NewProfileDslFileWizard_initialContent, module);
		...
		mainPage.setTitle(Messages.NewProfileDslFileWizard_title);
		mainPage.setDescription(Messages.NewProfileDslFileWizard_description);
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(Messages.NewProfileDslFileWizard_title);
