...
import org.xkonnex.repo.server.web.connex.web.ConnexApplication;
import org.xkonnex.repo.server.web.connex.web.HomePage;
import org.xkonnex.repo.server.web.connex.web.auth.AuthenticatedPage;
...
import org.xkonnex.repo.server.web.connex.web.auth.SignOutPage;
...
public abstract class ConnexPage<T> extends GenericWebPage<T> {
     ...
     */
    public ConnexPage(final PageParameters parameters) {
        super(parameters);
...
//        add(new Code("code-internal"));
    ...
    public Properties getProperties() {
        return ((ConnexApplication) ConnexApplication.get()).getProperties();
    }
